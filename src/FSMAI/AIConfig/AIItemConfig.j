library AIItemConfig
    ...
    function InitItemConfig takes nothing returns nothing
        ...
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 120.0 + 50.0) // hook radius + target radius
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_POINT_ALL_FRONT)
        ...
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, false)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I00P' // RunningShoes
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 60.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_INSTANT)
        call SaveInteger(ItemDataTable, currentItemId, FIND_TARGET_TYPE_KEY, FIND_TARGET_TYPE_NONE)
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, false)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I00R' // DrumOfEndurance
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_NONE)
        ...
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, true)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I018' // MantaStyle
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 45.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_INSTANT_SELF_DEFENSE_AND_CLEANSE)
        call SaveInteger(ItemDataTable, currentItemId, FIND_TARGET_TYPE_KEY, FIND_TARGET_TYPE_NONE)
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, false)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I00S' // WindWalkBoots
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 30.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_INSTANT_SELF_DEFENSE_AND_CLEANSE)
        ...
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, false)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I01C' // CompetitionBoots
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 350.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_NONE)
        ...
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, true)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I02H' // BeltOfGiantStrength
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_NONE)
        ...
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, true)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I011' // MagicWand
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 20.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_INSTANT_HEAL)
        call SaveInteger(ItemDataTable, currentItemId, FIND_TARGET_TYPE_KEY, FIND_TARGET_TYPE_NONE)
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, false)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I01A' // SpellShieldAmulet
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 40.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_NONE)
        call SaveInteger(ItemDataTable, currentItemId, FIND_TARGET_TYPE_KEY, FIND_TARGET_TYPE_NONE)
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, true)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I00T' // RingOfHealth
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_NONE)
        ...
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, true)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I00A' // BootsOfSpeed
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_NONE)
        ...
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, true)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I00X' // InvulnerabilityDust
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 22.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_INSTANT_SELF_DEFENSE_AND_CLEANSE)
        call SaveInteger(ItemDataTable, currentItemId, FIND_TARGET_TYPE_KEY, FIND_TARGET_TYPE_NONE)
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, false)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I00Z' // NewbeeReincarnation
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_NONE)
        ...
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, true)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I00U' // NewbeeReincarnation
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 26.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_INSTANT_HEAL)
        call SaveInteger(ItemDataTable, currentItemId, FIND_TARGET_TYPE_KEY, FIND_TARGET_TYPE_NONE)
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, false)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I00V' // SobiMask
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_NONE)
        ...
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, true)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I01B' // GlowingGrass
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_NONE)
        ...
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, true)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I00W' // Reincarnation
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_NONE)
        ...
        call SaveBoolean(ItemDataTable, currentItemId, IS_PASSIVE_KEY, true)
        call SaveReal(ItemDataTable, currentItemId, REQUIRED_CAST_TIME_KEY, 0.0)
        set currentItemId = 'I02G' // RingOfSelfDeprecation
        call SaveReal(ItemDataTable, currentItemId, BASE_COOLDOWN_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, CAST_RANGE_KEY, 0.0)
        call SaveReal(ItemDataTable, currentItemId, EFFECTIVE_RADIUS_KEY, 0.0)
        call SaveInteger(ItemDataTable, currentItemId, CAST_TYPE_KEY, CAST_NONE)
